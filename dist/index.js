...
function DynamicTable() {
    ...
    const [newColumnName, setNewColumnName] = (0, _react.useState)("");
    const [newColumnType, setNewColumnType] = (0, _react.useState)("string");
    ...
    const filteredRows = rows.filter((row)=>columns.some((col)=>{
            const cellValue = row[col.name]?.toString().toLowerCase();
            return cellValue?.includes(filter.toLowerCase());
        }));
    const sortColumn = (colName, type)=>{
        const sortedRows = [
            ...rows
        ].sort((a, b)=>{
            if (type === "number") return a[colName] - b[colName];
            else return a[colName].localeCompare(b[colName]);
        });
        setRows(sortedRows);
    };
    return /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("div", {
        children: [
            ...
            columns.length > 0 && /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("button", {
                onClick: addRow,
                children: "Add Row"
            }, void 0, false, {
                fileName: "index.js",
            ...
            columns.length > 0 && /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("table", {
                border: "1",
                children: [
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("thead", {
                        children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("tr", {
                            children: columns.map((col, index)=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("th", {
                                    onClick: ()=>sortColumn(col.name, col.type),
                                    children: [
                                        col.name,
                                        " (",
                                        col.type,
                    ...
                    /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("tbody", {
                        children: filteredRows.map((row, rowIndex)=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("tr", {
                                children: columns.map((col, colIndex)=>/*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("td", {
                                        children: /*#__PURE__*/ (0, _jsxDevRuntime.jsxDEV)("input", {
...
_s(DynamicTable, "BRHA8QCKwTTD7QELmxqcyw8AdPs=");
_c = DynamicTable;
...
},{"7422ead32dcc1e6b":"786KC"}]},["km5uZ","1xC6H","bB7Pu"], "bB7Pu", "parcelRequire5e3a")
